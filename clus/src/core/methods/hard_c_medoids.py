...
def hard_c_medoids(data: np.ndarray, distance_matrix: np.ndarray, components: int = 10, eps: float = 1e-4,
                   max_iter: int = 1000, initialization_method: str = "random_choice",
